...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-ssdump) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-map) COMPREPLY=( $(compgen -X '!*.map*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-sc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-a) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-ta) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-aa) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-mead) COMPREPLY=( $(compgen -X '!*.pqr*(.gz|.Z)' -f $c  ));;
-bf) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-ox) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-of) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
esac }
...
-tu) COMPREPLY=( $(compgen -W ' fs ps ns us ms s ' -- $c ));;
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-v) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-v2) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-eig) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-eig2) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-comp) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-rmsf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-proj) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-2d) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-3d) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-filt) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-extr) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-over) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-inpr) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ac) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-msd) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-av) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ee) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bal) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ov) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-of) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oh) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-or) COMPREPLY=( $(compgen -X '!*.trr*(.gz|.Z)' -f $c  ));;
esac }
...
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oi) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oh) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-l) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-d) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-ol) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oz) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-otr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-otl) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ok) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-okr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-okl) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oa) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
esac }
...
-P) COMPREPLY=( $(compgen -W ' 0 1 2 3 ' -- $c ));;
-fitfn) COMPREPLY=( $(compgen -W ' none exp aexp exp_exp vac exp5 exp7 exp9 erffit ' -- $c ));;
-s) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-ss) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-jc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-corr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-ot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oh) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-rt) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cp) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-dm) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-dist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ev) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-sz) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tr) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-ntr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-clid) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cl) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
esac }
...
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.tpr*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-ow) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-nc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ac) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-hc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-temp) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mcn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f1) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-f2) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-n1) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-n2) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-no) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-v) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-av) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-l) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-ascii) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-xpm) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-xpma) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-caf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dsp) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-md) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mj) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-ei) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-or) COMPREPLY=( $(compgen -X '!*.out*(.gz|.Z)' -f $c  ));;
-og) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-Spect) COMPREPLY=( $(compgen -X '!*.out*(.gz|.Z)' -f $c  ));;
esac }
...
-d) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-P) COMPREPLY=( $(compgen -W ' 0 1 2 3 ' -- $c ));;
-fitfn) COMPREPLY=( $(compgen -W ' none exp aexp exp_exp vac exp5 exp7 exp9 erffit ' -- $c ));;
-en) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-eps) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-a) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-d) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-adip) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dip3d) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cos) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cmap) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-q) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-slab) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-ds) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-da) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dn) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dm) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-l) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-q) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-x) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-lt) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-P) COMPREPLY=( $(compgen -W ' 0 1 2 3 ' -- $c ));;
-fitfn) COMPREPLY=( $(compgen -W ' none exp aexp exp_exp vac exp5 exp7 exp9 erffit ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-vacf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mvacf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dos) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-ot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oe) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-rhist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-khist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-cp) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-cs) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-ci) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-trj) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
esac }
...
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-groups) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-eref) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-emat) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-etot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-fitfn) COMPREPLY=( $(compgen -W ' none exp aexp exp_exp vac exp5 exp7 exp9 erffit ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-f2) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-viol) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-pairs) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ora) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ort) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oda) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-odr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-odt) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oten) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-corr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-vis) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ravg) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-odh) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-table) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-pot) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.itp*(.gz|.Z)' -f $c  ));;
-of) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-ol) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-oh) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-acf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-nm) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-num) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-ac) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ang) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-hx) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-hbn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-hbm) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-don) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dan) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-life) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-nhbdist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-to) COMPREPLY=( $(compgen -X '!*.g87*(.gz|.Z)' -f $c  ));;
-cz) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-co) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-oaxis) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-ocenter) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-orise) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oradius) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-otwist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-obending) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-otilt) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-orot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-d) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-d2) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-o2) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-o3) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ee) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-m) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-mean) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-frames) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-no) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-x) COMPREPLY=( $(compgen -X '!*.xtc*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-e) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-dat) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-on) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.out*(.gz|.Z)' -f $c  ));;
-ox) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-or) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f1) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-f2) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-or) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mol) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-pdb) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-f2) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-s1) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-s2) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-e) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-e2) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-m) COMPREPLY=( $(compgen -X '!*.tex*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-e) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-cp) COMPREPLY=( $(compgen -X '!*.cpt*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-mtx) COMPREPLY=( $(compgen -X '!*.mtx*(.gz|.Z)' -f $c  ));;
-om) COMPREPLY=( $(compgen -X '!*.mdp*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.mtx*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-of) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ol) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-os) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-qc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-v) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
esac }
...
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-v) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-e) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-nr) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ob) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-os) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-Sg) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-Sk) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-Sgsl) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-Sksl) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.out*(.gz|.Z)' -f $c  ));;
-so) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-v) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-i) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-a1) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-a2) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-a3) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-om) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-d) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-sq) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cn) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-hq) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-mir) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-a) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-m) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-bin) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-bm) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-equiv) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-rms) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-scl) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-mean) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-nmr3) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-nmr6) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-noe) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-q) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-oq) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-ox) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dir) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.mdp*(.gz|.Z)' -f $c  ));;
-po) COMPREPLY=( $(compgen -X '!*.mdp*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-r) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-rb) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-p) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-pp) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-t) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-e) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-ref) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-d) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-pr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-sq) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-prframe) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-sqframe) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-or) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oa) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tv) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-q) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-i) COMPREPLY=( $(compgen -X '!*.itp*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-sf) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-os) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oi) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-om) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-on) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-oa) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-od) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-od1) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-od2) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-xvg) COMPREPLY=( $(compgen -W ' xmgrace xmgr none ' -- $c ));;
-f) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ge) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ene) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-dist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-histo) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bin) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-lp) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-ls) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-lsh) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-lss) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-map) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-ls3) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-mdata) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
esac }
...
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-no) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ro) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-co) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-rc) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-ox) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oxt) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-ov) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-of) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ob) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ekt) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ekr) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-vd) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-cv) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-cf) COMPREPLY=( $(compgen -X '!*.pdb*(.gz|.Z)' -f $c  ));;
-av) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-af) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-p) COMPREPLY=( $(compgen -X '!*.out*(.gz|.Z)' -f $c  ));;
-err) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-so) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-x) COMPREPLY=( $(compgen -X '!*.xtc*(.gz|.Z)' -f $c  ));;
-cpi) COMPREPLY=( $(compgen -X '!*.cpt*(.gz|.Z)' -f $c  ));;
-cpo) COMPREPLY=( $(compgen -X '!*.cpt*(.gz|.Z)' -f $c  ));;
-c) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-e) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-g) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-dhdl) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-field) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-table) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tabletf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tablep) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tableb) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-rerun) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|cpt|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-tpi) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tpid) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ei) COMPREPLY=( $(compgen -X '!*.edi*(.gz|.Z)' -f $c  ));;
-eo) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-j) COMPREPLY=( $(compgen -X '!*.gct*(.gz|.Z)' -f $c  ));;
-jo) COMPREPLY=( $(compgen -X '!*.gct*(.gz|.Z)' -f $c  ));;
-ffout) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-devout) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-runav) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-px) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-pf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ro) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ra) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-rs) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-rt) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-mtx) COMPREPLY=( $(compgen -X '!*.mtx*(.gz|.Z)' -f $c  ));;
-dn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-bo) COMPREPLY=( $(compgen -X '!*.+(trr|cpt|trj)*(.gz|.Z)' -f $c  ));;
-bx) COMPREPLY=( $(compgen -X '!*.xtc*(.gz|.Z)' -f $c  ));;
-bcpo) COMPREPLY=( $(compgen -X '!*.cpt*(.gz|.Z)' -f $c  ));;
-bc) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
-be) COMPREPLY=( $(compgen -X '!*.edr*(.gz|.Z)' -f $c  ));;
-bg) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-beo) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bdhdl) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bfield) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-btpi) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-btpid) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bjo) COMPREPLY=( $(compgen -X '!*.gct*(.gz|.Z)' -f $c  ));;
-bffout) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bdevout) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-brunav) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bpx) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bpf) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bro) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bra) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-brs) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-brt) COMPREPLY=( $(compgen -X '!*.log*(.gz|.Z)' -f $c  ));;
-bmtx) COMPREPLY=( $(compgen -X '!*.mtx*(.gz|.Z)' -f $c  ));;
-bdn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-om) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-or) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-ot) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-ix) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-if) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-it) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-ip) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-hist) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-oiact) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-iiact) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-bsres) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-bsprof) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
-tab) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.eps*(.gz|.Z)' -f $c  ));;
esac }
...
case "$p" in
-f) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-r) COMPREPLY=( $(compgen -X '!*.rtp*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-tar) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-ori) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.edi*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz|tpr|tpb|tpa)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-mtx) COMPREPLY=( $(compgen -X '!*.mtx*(.gz|.Z)' -f $c  ));;
-dn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-multidir) COMPREPLY=( $(compgen -X '!*.*(.gz|.Z)' -f $c  ));;
-membed) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-mp) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-mn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-mtx) COMPREPLY=( $(compgen -X '!*.mtx*(.gz|.Z)' -f $c  ));;
-dn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-multidir) COMPREPLY=( $(compgen -X '!*.line_buf*(.gz|.Z)' -f $c  ));;
-membed) COMPREPLY=( $(compgen -X '!*.dat*(.gz|.Z)' -f $c  ));;
-mp) COMPREPLY=( $(compgen -X '!*.top*(.gz|.Z)' -f $c  ));;
-mn) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
esac }
...
-i) COMPREPLY=( $(compgen -X '!*.itp*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-q) COMPREPLY=( $(compgen -X '!*.+(gro|g96|pdb|brk|ent|esp|xyz)*(.gz|.Z)' -f $c  ));;
esac }
...
-o) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-demux) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-s) COMPREPLY=( $(compgen -X '!*.+(tpr|tpb|tpa|gro|g96|pdb|brk|ent)*(.gz|.Z)' -f $c  ));;
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-fr) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-sub) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-drop) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-n) COMPREPLY=( $(compgen -X '!*.ndx*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.+(xtc|trr|trj|gro|g96|pdb|g87)*(.gz|.Z)' -f $c  ));;
-nshell) COMPREPLY=( $(compgen -X '!*.xvg*(.gz|.Z)' -f $c  ));;
esac }
...
-f) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-f2) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
-di) COMPREPLY=( $(compgen -X '!*.m2p*(.gz|.Z)' -f $c  ));;
-do) COMPREPLY=( $(compgen -X '!*.m2p*(.gz|.Z)' -f $c  ));;
-o) COMPREPLY=( $(compgen -X '!*.eps*(.gz|.Z)' -f $c  ));;
-xpm) COMPREPLY=( $(compgen -X '!*.xpm*(.gz|.Z)' -f $c  ));;
esac }
